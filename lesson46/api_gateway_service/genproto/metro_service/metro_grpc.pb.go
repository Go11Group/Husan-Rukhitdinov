...
type MetroServiceClient interface {
	Cards(ctx context.Context, in *Card, opts ...grpc.CallOption) (*empty.Empty, error)
	Stations(ctx context.Context, in *Station, opts ...grpc.CallOption) (*empty.Empty, error)
	Terminals(ctx context.Context, in *Terminal, opts ...grpc.CallOption) (*empty.Empty, error)
	Transactions(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *metroServiceClient) Cards(ctx context.Context, in *Card, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *metroServiceClient) Stations(ctx context.Context, in *Station, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *metroServiceClient) Terminals(ctx context.Context, in *Terminal, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *metroServiceClient) Transactions(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type MetroServiceServer interface {
	Cards(context.Context, *Card) (*empty.Empty, error)
	Stations(context.Context, *Station) (*empty.Empty, error)
	Terminals(context.Context, *Terminal) (*empty.Empty, error)
	Transactions(context.Context, *Transaction) (*empty.Empty, error)
...
func (UnimplementedMetroServiceServer) Cards(context.Context, *Card) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Cards not implemented")
}
func (UnimplementedMetroServiceServer) Stations(context.Context, *Station) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Stations not implemented")
}
func (UnimplementedMetroServiceServer) Terminals(context.Context, *Terminal) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Terminals not implemented")
}
func (UnimplementedMetroServiceServer) Transactions(context.Context, *Transaction) (*empty.Empty, error) {
